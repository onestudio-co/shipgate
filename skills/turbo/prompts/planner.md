...
Return only:
- Path of spec file written
- Path of plan file written
- Wave count
- Max wave width (= max number of tasks in any single wave; used by coordinator to size the implementer team)
- Any DAG validation warnings
